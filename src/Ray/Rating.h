...
const std::string po_features_name[F_MAX1 + F_MAX2] = {
    "SAVE_CAPTURE1_1         ", "SAVE_CAPTURE1_2         ",
    "SAVE_CAPTURE1_3         ", "SAVE_CAPTURE2_1         ",
    "SAVE_CAPTURE2_2         ", "SAVE_CAPTURE2_3         ",
    "SAVE_CAPTURE3_1         ", "SAVE_CAPTURE3_2         ",
    "SAVE_CAPTURE3_3         ", "SAVE_CAPTURE_SELF_ATARI ",
    "2POINT_CAPTURE_SMALL    ", "2POINT_CAPTURE_LARGE    ",
    "3POINT_CAPTURE_SMALL    ", "3POINT_CAPTURE_LARGE    ",
    "CAPTURE                 ", "CAPTURE_AFTER_KO        ",
    "SAVE_EXTENSION_SAFELY1  ", "SAVE_EXTENSION_SAFELY2  ",
    "SAVE_EXTENSION_SAFELY3  ", "SAVE_EXTENSION1         ",
    "SAVE_EXTENSION2         ", "SAVE_EXTENSION3         ",
    "SELF_ATARI_SMALL        ", "SELF_ATARI_NAKADE       ",
    "SELF_ATARI_LARGE        ", "ATARI                   ",
    "2POINT_ATARI_SMALL      ", "2POINT_ATARI_LARGE      ",
    "2POINT_C_ATARI_SMALL    ", "2POINT_C_ATARI_LARGE    ",
    "3POINT_ATARI_SMALL      ", "3POINT_ATARI_LARGE      ",
    "3POINT_C_ATARI_SMALL    ", "3POINT_C_ATARI_LARGE    ",
    "3POINT_DAME_SMALL       ", "3POINT_DAME_LARGE       ",
    "2POINT_EXTENSION_SAFELY ", "2POINT_EXTENSION        ",
    "3POINT_EXTENSION_SAFELY ", "3POINT_EXTENSION        ",
    "THROW_IN_2              ",
};
