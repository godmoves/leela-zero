...
const int OB_SIZE = 5; // 
const int 
ray_BOARD_SIZE = (PURE_BOARD_SIZE + OB_SIZE + OB_SIZE); // 
...
const int STRING_LIB_MAX = (
ray_BOARD_SIZE * (PURE_BOARD_SIZE + OB_SIZE));  // 1
const int STRING_POS_MAX = (
ray_BOARD_SIZE * (PURE_BOARD_SIZE + OB_SIZE));  // 
